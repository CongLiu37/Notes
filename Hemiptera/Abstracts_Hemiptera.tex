...
\begin{sloppypar}
  ...
  \linenumbers
\textbf{1. Altincicek \textit{et al.}, 2008, Wounding-mediated gene expression and accelerated viviparous reproduction of the pea aphid Acyrthosiphon pisum.}
\par
\textbf{2. Gerardo \textit{et al.}, 2010, Immunity and other defenses in pea aphids, Acyrthosiphon pisum.}
\par
\textbf{3. Kim and Lee, 2017, Insect symbiosis and immunity: the bean bug-Burkholderia interaction as a case study.}
\par
\textbf{4. Husink and McCutcheon, 2016, Repeated replacement of an intrabacterial symbiont in the tripartite nested mealybug symbiosis.
}
\par
\textbf{5. Gil \textit{et al.}, 2017, Tremblaya phenacola PPER: an evolutionary beta-gamma-proteobacterium collage.}
\par
\textbf{6. Szabo \textit{et al.}, 2017, Convergent patterns in the evolution of mealybug symbioses involving different intrabacterial symbiosis.}
\par
\textbf{7. Bublitz \textit{et al.}, 2019, Peptidoglycan production by an insect-bacterial mosaic citrus mealybug, Tremblaya, Mornaella.}
\par
\textbf{8. Husink \textit{et al.}, Horizontal gene transfer from diverse bacteria to an insect genome enables a tripartite nested mealybug symbiosis.}
\par
\textbf{9. McCutcheon and Dohlen, 2011, An interdependent metabolic patchwork in the nested symbiosis of mealybug.}
