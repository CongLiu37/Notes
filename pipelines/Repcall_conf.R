...
# sp.lst=d[,"Label"]
# dire="/flash/BourguignonU/Cong/termite_genome_annotation/tRNAscan_filter"
# for (sp in sp.lst){
...
#   write("#SBATCH --mem=500G",shell,append=TRUE)
#   write("#SBATCH --ntasks=1",shell,append=TRUE)
#   write("#SBATCH --cpus-per-task=128",shell,append=TRUE)
...
#   write(paste("Rscript /flash/BourguignonU/Cong/termite_genome_annotation/tRNAscan_filter/tRNA.R ",sp,sep=""),
#         shell,append=TRUE)
# }
